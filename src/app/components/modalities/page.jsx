                ...
                <div className='flex xl:gap-20 gap-12 items-center lg:flex-nowrap flex-wrap'>
                    <div className='lg:w-[40%] w-full flex flex-col lg:gap-4 gap-3'>
                        ...
                        <div className='xl:mt-1 mt-3 flex lg:justify-normal justify-end'>
                            <h1 className='font-inter font-medium items-center flex cursor-pointer group gap-2'>Choose Your Engagement Epic <FiArrowUpRight className='text-lg group-hover:rotate-45 transition-all duration-200' /></h1>
                        </div>
                    </div>
                    <div className='lg:w-[60%] w-full flex flex-col gap-12'>
                        <div className='border-[1px] border-[#C2CDD5] py-3 px-4 shadow-techShadow rounded-xl'>
                            ...
                            <div className='mt-4 flex flex-col gap-3'>
                                ...
                                <h1 className='font-inter font-medium flex gap-1 items-center group cursor-pointer w-fit'>Learn More <FiArrowUpRight className='text-lg group-hover:rotate-45 transition-all duration-200' /></h1>
                            </div>
                        </div>
